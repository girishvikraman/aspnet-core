...
{
    public class EYVAPPDbMigrationService : ITransientDependency
    {
        public ILogger<EYVAPPDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IEYVAPPDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public EYVAPPDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IEYVAPPDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<EYVAPPDbMigrationService>.Instance;
        }
